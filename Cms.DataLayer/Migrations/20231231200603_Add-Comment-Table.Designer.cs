...
namespace Cms.DataLayer.Migrations
{
    ...
    [Migration("20231231200603_Add-Comment-Table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cms.DataLayer.Entities.Content.ContentComment", b =>
                {
            ...
            modelBuilder.Entity("Cms.DataLayer.Entities.Shop.DiscountCodeUser", b =>
                {
                    b.Property<int>("DisCodeUserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DisCodeUserId"));
            ...
            modelBuilder.Entity("Cms.DataLayer.Entities.Content.ContentComment", b =>
                {
                    b.HasOne("Cms.DataLayer.Entities.Content.BaseContent", "Content")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Cms.DataLayer.Entities.Shop.DiscountCodeUser", b =>
                {
                    b.HasOne("Cms.DataLayer.Entities.Shop.DiscountCode", null)
                        .WithMany("DiscountCodeUsers")
                        .HasForeignKey("DiscountCodeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Cms.DataLayer.Entities.User", null)
                        .WithMany("DiscountCodeUsers")
